...
WIENER_NEUSTADT_STATION_ID = os.environ.get("WIENER_NEUSTADT_STATION_ID", "8100516")  # Wiener Neustadt Hbf (Südbahn)
BADEN_STATION_ID = os.environ.get("BADEN_STATION_ID", "1130604")  # Baden bei Wien (Südbahn)
